...
export const GuideToolUserCreateRequestView: FC<
	GuideToolUserCreateRequestViewProps
> = (props) => {
	...
	const sendRequest = () => {
		setIsPending(true);
		SendMessageComposer(
			new GuideSessionCreateMessageComposer(1, userRequest)
		);
	};
		...
		<Column>
			...
			<textarea
				...
				placeholder={LocalizeText(
					"guide.help.request.user.create.input.help"
				)}
			></textarea>
			<Button
				variant="primary"
