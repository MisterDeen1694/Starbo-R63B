...
export const FurnitureCraftingView: FC<{}> = (props) => {
	...
	const canCraft = useMemo(() => {
		...
		for (const ingredient of requiredIngredients) {
			const ingredientData = ingredients.find(
				(data) => data.name === ingredient.itemName
			);

			if (!ingredientData || ingredientData.count < ingredient.count)
				return false;
		}
	...
	return (
		<NitroCardView className="nitro-widget-crafting" theme="primary-slim">
			<NitroCardHeaderView
				headerText={LocalizeText("crafting.title")}
