				...
				<Column>
					<Flex alignItems="center" justifyContent="between" gap={2}>
						...
						<FaTimes
							...
							onClick={(event) =>
								hideFriendRequest(request.requesterUserId)
							}
						/>
					</Flex>
					<Flex justifyContent="end" gap={1}>
						<Button
							variant="primary"
							onClick={(event) =>
								requestResponse(request.requesterUserId, false)
							}
						>
						...
						<Button
							variant="primary"
							onClick={(event) =>
								requestResponse(request.requesterUserId, true)
							}
						>
