				...
				<>
					{avatarInfo.botSkills.indexOf(
						...
						<ContextMenuListItemView
							onClick={(event) => processAction("donate_to_all")}
						>
					...
					{avatarInfo.botSkills.indexOf(
						...
						<ContextMenuListItemView
							onClick={(event) => processAction("donate_to_user")}
						>
					...
					{avatarInfo.botSkills.indexOf(BotSkillsEnum.DRESS_UP) >=
						0 && (
						<ContextMenuListItemView
							onClick={(event) => processAction("dress_up")}
						>
							{LocalizeText("avatar.widget.dress_up")}
						</ContextMenuListItemView>
					)}
					{avatarInfo.botSkills.indexOf(BotSkillsEnum.RANDOM_WALK) >=
						0 && (
						<ContextMenuListItemView
							onClick={(event) => processAction("random_walk")}
						>
							{LocalizeText("avatar.widget.random_walk")}
						</ContextMenuListItemView>
					)}
					{avatarInfo.botSkills.indexOf(BotSkillsEnum.SETUP_CHAT) >=
						0 && (
						<ContextMenuListItemView
							onClick={(event) => processAction("setup_chat")}
						>
					...
					{avatarInfo.botSkills.indexOf(BotSkillsEnum.DANCE) >= 0 && (
						<ContextMenuListItemView
							onClick={(event) => processAction("dance")}
						>
							{LocalizeText("avatar.widget.dance")}
						</ContextMenuListItemView>
					)}
					{avatarInfo.botSkills.indexOf(BotSkillsEnum.NO_PICK_UP) ===
						-1 && (
						<ContextMenuListItemView
							onClick={(event) => processAction("pick")}
						>
			...
			{mode === MODE_CHANGE_NAME && (
				<Column className="menu-item" onClick={null} gap={1}>
					...
					<Flex alignItems="center" justifyContent="between" gap={1}>
						<Button
							variant="primary"
							onClick={(event) => processAction(null)}
						>
							{LocalizeText("cancel")}
						</Button>
						<Button
							variant="primary"
							onClick={(event) => processAction("save_bot_name")}
						>
							{LocalizeText("save")}
						</Button>
					</Flex>
			...
			{mode === MODE_CHANGE_MOTTO && (
				<Column className="menu-item" onClick={null} gap={1}>
					...
					<Flex alignItems="center" justifyContent="between" gap={1}>
						...
						<Button
							variant="primary"
							onClick={(event) => processAction("save_bot_motto")}
						>
							{LocalizeText("save")}
						</Button>
					</Flex>
