...
export const RoomPromoteMyOwnEventWidgetView: FC<
	RoomPromoteMyOwnEventWidgetViewProps
> = (props) => {
	...
	return (
		<>
			...
			<Grid className="d-flex align-items-center justify-content-end gap-2">
				<Button onClick={(event) => setIsEditingPromote(true)}>
					{LocalizeText("navigator.roominfo.editevent")}
				</Button>
				<Button onClick={(event) => extendPromote()}>
