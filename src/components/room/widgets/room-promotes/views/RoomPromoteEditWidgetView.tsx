...
export const RoomPromoteEditWidgetView: FC<RoomPromoteEditWidgetViewProps> = (
	props
) => {
	const {
		eventId = -1,
			...
			<NitroCardContentView className="text-black">
				...
				<Column>
					<Button
						...
						variant={
							!newEventName || !newEventDescription
								? "primary"
								: "primary"
						}
