				...
				>
					<NitroCardHeaderView
						...
						headerText={
							objectType === "gnome_box"
								? LocalizeText(
										"widgets.gnomepackage.name.title"
								  )
					...
					<NitroCardContentView>
						<Flex className="pet-package-container-top p-3">
							<div
								className={`package-image-${objectType} flex-shrink-0`}
							></div>
							<div className="m-2">
								<Text
									variant="white"
							...
							<Column gap={1}>
								...
								>
									<input
										...
										maxLength={GetConfiguration(
											"pet.package.name.max.length"
										)}
										placeholder={
											objectType === "gnome_box"
												? LocalizeText(
														"widgets.gnomepackage.name.select"
												  )
												: LocalizeText(
								...
								>
									...
									>
										{objectType === "gnome_box"
											? LocalizeText(
													"widgets.gnomepackage.name.pick"
											  )
											: LocalizeText(
													"furni.petpackage.confirm"
											  )}
									</Button>
								</Flex>
							</Column>
