				...
				<Grid>
					...
					<Column justifyContent="between" size={7} overflow="hidden">
						{sanctionInfo.sanctionReason === "cfh.reason.EMPTY" ? (
							...
							<>
								{(sanctionInfo.probationHoursLeft > 0 ||
									sanctionInfo.isSanctionActive) && (
									<div className="col-12 fw-bold">
										{LocalizeText(
											"help.sanction.probation.reminder"
										)}
									</div>
								)}
								<div
									className={`col-12 fw-bold ${
										sanctionInfo.isSanctionNew
											? "text-danger"
											: ""
									}`}
								>
									{LocalizeText(
										"help.sanction.last.sanction"
									)}{" "}
								...
								<div className="col-12">
									{LocalizeText("generic.start.time")}{" "}
									{sanctionInfo.sanctionCreationTime}
								</div>
								<div className="col-12">
									{LocalizeText("generic.reason")}{" "}
									{sanctionInfo.sanctionReason}
								</div>
								<div className="col-12">
									{LocalizeText(
										"help.sanction.probation.days.left"
									)}{" "}
									{Math.trunc(
										sanctionInfo.probationHoursLeft / 24
									) + 1}
								</div>
							</>
						)}
						{sanctionInfo.hasCustomMute &&
							!sanctionInfo.isSanctionActive && (
								<div className="col-12 fw-bold">
									{LocalizeText("help.sanction.custom.mute")}
								</div>
							)}
						{sanctionInfo.tradeLockExpiryTime &&
							sanctionInfo.tradeLockExpiryTime.length > 0 && (
								<div className="col-12 fw-bold">
									{LocalizeText("trade.locked.until")}{" "}
									{sanctionInfo.tradeLockExpiryTime}
								</div>
							)}
						<div className="col-12">
						...
						<Button
							variant="primary"
							onClick={(event) => setSanctionInfo(null)}
						>
