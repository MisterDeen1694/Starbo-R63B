...
export const ModToolsMyIssuesTabView: FC<ModToolsMyIssuesTabViewProps> = (
	props
) => {
							...
							>
								...
								<Base className="g-col-2">
									<Button
										...
										onClick={(event) =>
											SendMessageComposer(
												new ReleaseIssuesMessageComposer(
													[issue.issueId]
												)
											)
										}
